...
export default function Body() {
  ...
  return (
    <div className="flex flex-col items-center mt-24 mb-16  ">
      <h1 className=" text-sm lg:text-lg text-slate-600 my-4 font-medium ">My Stopwatch</h1>
      ...
      <div className="flex  w-full justify-between lg:mb-9 font-light text-sm">
       
      </div>
      <div className="">
        <button
          className="px-7 py-3 mx-7 my-10 text-xl font-extrabold text-slate-500  bg-btncolor rounded-2xl border-gray-300 hover:bg-sec-btncolor hover:text-slate-700"
