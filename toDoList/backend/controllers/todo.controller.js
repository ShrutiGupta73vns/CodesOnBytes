...
const updateTodo=async(req,res,next)=>{
    try {
       ...
       const  updatedItem= await Todo.findOneAndUpdate({_id:id},{title,description},{new:true })
...
const updatedItem= await Todo.findOneAndUpdate({_id:id},{checked:isChecked},{new:true})
res.status(201).json(updatedItem)
